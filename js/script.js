...
const translations = {
  id: {
    ...
    lmsMessageInbox: "Pesan Masuk",
    lmsMessageHistory: "Riwayat",
    lmsMessageArchive: "Arsip",
    // LMS admin
    ...
    adProfileInformation: "Informasi Profil",
    adChangePhoto: "Ganti Foto",
    adProfileBioPlaceholder: "Ceritakan tentang diri Anda kepada student...",
    adSelectOption: "-- Pilih --",
    adCategoryAgedCare: "Perawatan Lansia",
    adCategoryDisabilitySupport: "Dukungan Disabilitas",
    adCategoryFirstAid: "Pertolongan Pertama",
    adCategoryMentalHealth: "Kesehatan Mental",
    adCategoryMedication: "Bantuan Obat",
    adCategoryManualHandling: "Manual Handling",
    adCategoryInfectionControl: "Pengendalian Infeksi",
    adCategoryCommunication: "Komunikasi",
    adLevelBeginner: "Pemula",
    adLevelIntermediate: "Menengah",
    adLevelAdvanced: "Mahir",
    adLessonTypeVideo: "📹 Video",
    adLessonTypePdf: "📄 PDF",
    adLessonTypeText: "📝 Teks",
    adLessonTypeQuiz: "❓ Kuis",
    adLessonTypeAssignment: "📋 Tugas",
    adModuleTitlePlaceholder: "Judul modul...",
    adLessonTitlePlaceholder: "Judul lesson...",
    adUploadMaterial: "Unggah Materi",
    adNoFileSelected: "Belum ada file dipilih",
    adNo: "Tidak",
    adYes: "Ya",
    adAssignmentNewTitle: "Buat Tugas Baru",
    adClose: "Tutup",
    adAssignmentTitle: "Judul Tugas *",
    adAssignmentTitlePlaceholder: "Contoh: Studi Kasus Perawatan Lanjut Usia",
    adAssignmentDesc: "Deskripsi / Instruksi",
    adAssignmentDescPlaceholder: "Jelaskan apa yang harus dikerjakan student...",
    adAssignmentCourse: "Kursus *",
    adAssignmentSelectCourse: "Pilih kursus...",
    adAssignmentType: "Tipe",
    adAssignmentTypeFile: "📋 Tugas (Upload File)",
    adAssignmentTypeQuiz: "📝 Kuis (Teks + Upload)",
    adAssignmentDeadline: "Deadline *",
    adAssignmentMaxScore: "Nilai Maksimal",
    adAssignmentsCreated: "Tugas yang Sudah Dibuat",
    adRefresh: "Refresh",
    adAssignmentsEmpty: "Belum ada tugas yang dibuat.",
    adCompetencyStatus: "Status Kompetensi",
    adEventTypeLiveSession: "Sesi Live",
    adEventTypeWebinar: "Webinar",
    adEventTypeExam: "Ujian",
    adEventTypeOrientation: "Orientasi",
    adEventTypeOther: "Lainnya",
    adAllEnrolledStudents: "Semua Student Terdaftar",
    adMsgSubjectPlaceholder: "Subjek pesan...",
    adTargetStudentsOnly: "Student Saja",
    adTargetTrainersOnly: "Trainer Saja",
    adAllCoursesGlobal: "Semua Kursus (Global)",
    // LMS Admin Keys
    ...
    lmsMessages: "Pesan",
    lmsResources: "Materi",
    lmsCompetencyResult: "Hasil Kompetensi",
    lmsCompetencyLoading: "Memuat status asesmen...",
    ...
    lmsResourceVideo: "Video",
    lmsResourcePdf: "PDF",
    lmsResourceQuiz: "Kuis",
    lmsResourceText: "Teks",
...
Pengalaman belajar yang lebih praktis dan efisien ini mencakup berbagai format, dengan menyeimbangkan metode tradisional seperti kuis, ujian tertulis, dan tes benar/salah, serta strategi alternatif yang sangat aplikatif seperti proyek kelompok, studi kasus, portofolio, dan simulasi interaktif.`,
    ...
    teamReadMore: "Baca Selengkapnya →",
    teamReadMoreAydaAria: "Baca bio lengkap Ayda Khadiva",
    teamReadMoreStefanusAria: "Baca bio lengkap Stefanus Titaheluw",
    teamReadMoreVictoriaAria: "Baca bio lengkap Victoria Edmonds",
    teamModalCloseAria: "Tutup modal",
    teamAydaModalBio:
      "<p>Sebagai bagian dari Redline Academy, Ayda percaya bahwa pengembangan kemampuan tidak hanya berarti menambah pengetahuan, tetapi juga membentuk cara berpikir, cara bekerja, dan kesiapan menghadapi situasi nyata.</p><p>Dengan latar belakang di bidang pengembangan organisasi dan human capital, Ayda berfokus membantu individu dan tim berkembang melalui pendekatan yang terstruktur, kontekstual, dan relevan dengan kebutuhan kerja.</p><p>Di Redline Academy, ia terlibat langsung dalam perancangan program, pengembangan kurikulum, dan penjagaan kualitas pengalaman belajar agar setiap materi tidak hanya informatif, tetapi juga berdampak nyata.</p>",
    teamStefanusModalBio:
      "<p>Didorong oleh transformasi berbasis teknologi dalam eLearning, kesehatan digital, dan arsitektur microservices, Stefanus membawa kepemimpinan serta pengalaman praktis yang menghubungkan sektor kesehatan dan layanan komunitas dengan keahlian Online Learning and Assessment Skill Set.</p><p>Dengan menanamkan standar pendidikan dan pelatihan vokasi ke dalam metode penyampaian digital modern, ia berfokus membangun tim yang beragam, membuka ruang bagi ide-ide baru, dan menciptakan lingkungan yang menjunjung tinggi tanggung jawab bersama.</p><p>Kombinasi keahlian ini memastikan Redline Academy tidak sekadar menyelenggarakan pendidikan, tetapi juga membangun jalur pengembangan profesional yang berkelanjutan, didukung teknologi, dan memberdayakan setiap individu untuk mencapai potensi terbaiknya.</p>",
    teamVictoriaModalBio:
      "<p>Dengan pengalaman bertahun-tahun di bidang pendidikan, penyelenggaraan pelatihan, dan desain pembelajaran, Victoria meyakini bahwa efisiensi tenaga kerja yang sesungguhnya memerlukan pendekatan holistik: mengembangkan karyawan yang menguasai keterampilan inti di tempat kerja sekaligus kompetensi teknis sesuai peran dan tanggung jawab mereka.</p><p>Praktik profesionalnya berlandaskan keyakinan bahwa dengan alat yang tepat, bimbingan berkualitas, serta lingkungan yang positif dan mendorong perkembangan, setiap individu memiliki kemampuan untuk mencapai potensi terbaiknya dan memberikan nilai yang luar biasa bagi organisasi.</p>",
    ...
    paymentPlanInstallmentDesc: "Rp500.000/bulan hingga lunas",
  ...
  en: {
    ...
    lmsMessageInbox: "Inbox",
    lmsMessageHistory: "History",
    lmsMessageArchive: "Archive",
    // LMS admin
    adAddUser: "Add User",
    ...
    adProfileInformation: "Profile Information",
    adChangePhoto: "Change Photo",
    adProfileBioPlaceholder: "Tell students about yourself...",
    adSelectOption: "-- Select --",
    adCategoryAgedCare: "Aged Care",
    adCategoryDisabilitySupport: "Disability Support",
    adCategoryFirstAid: "First Aid",
    adCategoryMentalHealth: "Mental Health",
    adCategoryMedication: "Medication Assistance",
    adCategoryManualHandling: "Manual Handling",
    adCategoryInfectionControl: "Infection Control",
    adCategoryCommunication: "Communication",
    adLevelBeginner: "Beginner",
    adLevelIntermediate: "Intermediate",
    adLevelAdvanced: "Advanced",
    adLessonTypeVideo: "📹 Video",
    adLessonTypePdf: "📄 PDF",
    adLessonTypeText: "📝 Text",
    adLessonTypeQuiz: "❓ Quiz",
    adLessonTypeAssignment: "📋 Assignment",
    adModuleTitlePlaceholder: "Module title...",
    adLessonTitlePlaceholder: "Lesson title...",
    adUploadMaterial: "Upload Material",
    adNoFileSelected: "No file selected",
    adNo: "No",
    adYes: "Yes",
    adAssignmentNewTitle: "Create New Assignment",
    adClose: "Close",
    adAssignmentTitle: "Assignment Title *",
    adAssignmentTitlePlaceholder: "Example: Elder Care Case Study",
    adAssignmentDesc: "Description / Instructions",
    adAssignmentDescPlaceholder: "Explain what students need to do...",
    adAssignmentCourse: "Course *",
    adAssignmentSelectCourse: "Select course...",
    adAssignmentType: "Type",
    adAssignmentTypeFile: "📋 Assignment (Upload File)",
    adAssignmentTypeQuiz: "📝 Quiz (Text + Upload)",
    adAssignmentDeadline: "Deadline *",
    adAssignmentMaxScore: "Maximum Score",
    adAssignmentsCreated: "Created Assignments",
    adRefresh: "Refresh",
    adAssignmentsEmpty: "No assignments created yet.",
    adCompetencyStatus: "Competency Status",
    adEventTypeLiveSession: "Live Session",
    adEventTypeWebinar: "Webinar",
    adEventTypeExam: "Exam",
    adEventTypeOrientation: "Orientation",
    adEventTypeOther: "Other",
    adAllEnrolledStudents: "All Enrolled Students",
    adMsgSubjectPlaceholder: "Message subject...",
    adTargetStudentsOnly: "Students Only",
    adTargetTrainersOnly: "Trainers Only",
    adAllCoursesGlobal: "All Courses (Global)",
    // LMS Admin Keys
    adNavDashboard: "Dashboard",
    ...
    lmsCompetencyResult: "Competency Result",
    lmsCompetencyLoading: "Loading assessment status...",
    ...
    lmsResourceVideo: "Video",
    lmsResourcePdf: "PDF",
    lmsResourceQuiz: "Quiz",
    lmsResourceText: "Text",
    ...
    teamReadMore: "Read More →",
    teamReadMoreAydaAria: "Read Ayda Khadiva's full bio",
    teamReadMoreStefanusAria: "Read Stefanus Titaheluw's full bio",
    teamReadMoreVictoriaAria: "Read Victoria Edmonds' full bio",
    teamModalCloseAria: "Close modal",
    teamAydaModalBio:
      "<p>As part of Redline Academy, Ayda believes capability development is not only about adding knowledge, but also about shaping mindsets, work habits, and readiness for real-world situations.</p><p>With a background in organisational development and human capital, Ayda focuses on helping individuals and teams grow through structured, contextual approaches that stay relevant to workplace needs.</p><p>At Redline Academy, she is directly involved in program design, curriculum development, and learning-experience quality so every material is not only informative, but also meaningfully impactful.</p>",
    teamStefanusModalBio:
      "<p>Driven by technology-led transformation in eLearning, digital health, and microservices architecture, Stefanus brings leadership and practical experience that connect the health and community services sectors with Online Learning and Assessment Skill Set expertise.</p><p>By embedding vocational education and training standards into modern digital delivery methods, he focuses on building diverse teams, opening space for new ideas, and creating an environment grounded in shared responsibility.</p><p>This combination of expertise ensures Redline Academy does more than deliver education; it builds sustainable professional development pathways that are technology-enabled and empower every individual to reach their best potential.</p>",
    teamVictoriaModalBio:
      "<p>With years of experience in education, training delivery, and learning design, Victoria believes true workforce efficiency requires a holistic approach: developing employees who master core workplace skills while also building the role-specific technical competencies required by their responsibilities.</p><p>Her professional practice is grounded in the belief that, with the right tools, quality guidance, and a positive environment that encourages growth, every individual has the ability to reach their best potential and deliver exceptional value to an organisation.</p>",
    ...
    paymentPlanInstallmentDesc: "IDR 500,000/month until paid",
...
Object.assign(translations.id, {
  ...
  footerDesc:
    "Platform pelatihan vokasi bersertifikat Australia yang diakui secara internasional.",
  logout: "Log Out",
  adNavArticles: "Kelola Artikel",
  caTabsAriaLabel: "Halaman artikel",
  caTabEditor: "✏️ Buat Artikel Baru",
  caTabList: "📋 Daftar Artikel",
  caEditorModeCreate: "Buat Artikel Baru",
  caEditorModeEdit: "Edit Artikel",
  caStatusDraft: "Draft",
  caStatusPublished: "Published",
  caBtnReset: "Reset Form",
  caBtnSaveDraft: "Simpan Draft",
  caBtnPublish: "Publikasikan",
  caMainContent: "Konten Utama",
  caArticleTitleLabel: "Judul Artikel <span class=\"ca-hint\">*wajib</span>",
  caArticleTitlePlaceholder: "Masukkan judul artikel yang menarik...",
  caSlugLabel:
    "URL Slug <span class=\"ca-hint\">*auto-generate dari judul</span>",
  caSlugPlaceholder: "judul-artikel-anda",
  caExcerptLabel:
    "Ringkasan / Excerpt <span class=\"ca-hint\">*untuk kartu artikel di beranda & blog (maks. 200 karakter)</span>",
  caExcerptPlaceholder:
    "Tulis ringkasan singkat yang menarik perhatian pembaca...",
  caArticleBody: "Isi Artikel",
  caToolbarAriaLabel: "Format teks",
  caToolbarBoldTitle: "Tebal",
  caToolbarItalicTitle: "Miring",
  caToolbarUnderlineTitle: "Garis bawah",
  caToolbarH2Title: "Heading 2",
  caToolbarH3Title: "Heading 3",
  caToolbarParagraphTitle: "Paragraf",
  caToolbarBulletTitle: "Daftar bullet",
  caToolbarBulletText: "• List",
  caToolbarNumberedTitle: "Daftar bernomor",
  caToolbarNumberedText: "1. List",
  caToolbarQuoteTitle: "Kutipan",
  caToolbarQuoteText: "❝ Quote",
  caToolbarLinkTitle: "Sisipkan link",
  caToolbarLinkText: "🔗 Link",
  caToolbarClearTitle: "Hapus format",
  caToolbarClearText: "✕ Clear",
  caContentAriaLabel: "Isi artikel",
  caEditorPlaceholder:
    "Mulai menulis isi artikel di sini... Gunakan toolbar di atas untuk memformat teks.",
  caMetadata: "Metadata",
  caBadgeLabel: "Label Badge <span class=\"ca-hint\">tampil di kartu</span>",
  caContentType: "Tipe Konten",
  caTypeArticle: "📄 Artikel",
  caTypeAudio: "🎧 Audio",
  caTypeVideo: "🎬 Video",
  caLevel: "Level",
  caLevelBeginner: "🟢 Pemula (Beginner)",
  caLevelIntermediate: "🟡 Menengah (Intermediate)",
  caLevelAdvanced: "🔴 Mahir (Advanced)",
  caReadTimeLabel:
    "Estimasi Baca <span class=\"ca-hint\">(menit)</span>",
  caCategoryLabel:
    "Kategori / Tag <span class=\"ca-hint\">pisahkan dengan koma</span>",
  caCategoryPlaceholder: "caregiver, pelatihan, karir",
  caHeaderImage: "Gambar Header",
  caImageUrlLabel: "URL Gambar",
  caImagePreviewAlt: "Preview gambar artikel",
  caImageHelperText:
    "Kosongkan untuk menggunakan gambar default. Gunakan URL gambar dari folder <code>assets/images/</code> atau URL eksternal.",
  caSeoOptional: "SEO (Opsional)",
  caMetaDescLabel:
    "Meta Description <span class=\"ca-hint\">(maks. 160 karakter)</span>",
  caMetaDescPlaceholder: "Deskripsi singkat untuk mesin pencari...",
  caListTitle: "Daftar Artikel",
  caBtnNewArticle: "+ Buat Artikel Baru",
  caEmptyList:
    "Belum ada artikel. Klik <strong>Buat Artikel Baru</strong> untuk memulai.",
  caToastViewArticle: "Lihat Artikel →",
  caPromptInsertLink: "Masukkan URL tautan:",
  caValidationTitleRequired: "Judul artikel wajib diisi.",
  caValidationSlugRequired: "URL slug wajib diisi.",
  caValidationExcerptRequired: "Ringkasan / excerpt wajib diisi.",
  caValidationContentRequired: "Isi artikel tidak boleh kosong.",
  caValidationSlugUsed: "Slug \"{slug}\" sudah digunakan.",
  caToastDraftSaved: "Draft berhasil disimpan!",
  caToastDraftFailed: "Gagal menyimpan draft. Coba lagi.",
  caConfirmPublish:
    "Artikel akan dipublikasikan dan tampil di beranda serta halaman blog. Lanjutkan?",
  caToastPublishSuccess: "Artikel berhasil dipublikasikan!",
  caToastPublishFailed: "Gagal mempublikasikan artikel. Coba lagi.",
  caConfirmReset: "Reset form? Perubahan yang belum disimpan akan hilang.",
  caLoadingArticles: "Memuat artikel...",
  caListPublishedDate: "Dipublish: {date}",
  caListUpdatedDate: "Diperbarui: {date}",
  caActionView: "Lihat",
  caActionEdit: "Edit",
  caActionPublish: "Publish",
  caActionDelete: "Hapus",
  caConfirmQuickPublish: "Publikasikan artikel \"{title}\"?",
  caToastQuickPublishFailed: "Gagal mempublikasikan.",
  caConfirmDelete:
    "Hapus artikel \"{title}\"? Tindakan ini tidak dapat dibatalkan.",
  caToastDeleteSuccess: "Artikel berhasil dihapus.",
  caToastDeleteFailed: "Gagal menghapus artikel.",
  avMetaReadTime: "⏱ {minutes} menit baca",
  avCtaTitle: "Siap Memulai Perjalananmu?",
  avCtaBody:
    "Program caregiver bersertifikat Australia. Mulai dari Rp 500rb/bulan.",
  avCtaButton: "Mulai Perjalananmu →",
  avBackToBlog: "← Kembali ke Blog",
  avTagLabel: "Tag:",
  avNotFoundTitle: "Artikel Tidak Ditemukan",
  avNotFoundBack: "Kembali ke Blog",
  avNoSlugFound: "Tidak ada slug artikel yang ditemukan.",
  avStoreUnavailable: "ArticlesStore tidak tersedia.",
  avArticleMissing:
    "Artikel dengan slug \"{slug}\" tidak ditemukan atau belum dipublikasikan.",
  avDocumentTitleNotFound: "Artikel Tidak Ditemukan | Redline Academy",
  avDifficultyBeginner: "🟢 Pemula",
  avDifficultyIntermediate: "🟡 Menengah",
  avDifficultyAdvanced: "🔴 Mahir",
...
Object.assign(translations.en, {
  ...
  privacyPolicy: "Privacy Policy",
  footerDesc:
    "Australian-accredited vocational training platform recognised internationally.",
  logout: "Log Out",
  adNavArticles: "Manage Articles",
  caTabsAriaLabel: "Article pages",
  caTabEditor: "✏️ Create New Article",
  caTabList: "📋 Article List",
  caEditorModeCreate: "Create New Article",
  caEditorModeEdit: "Edit Article",
  caStatusDraft: "Draft",
  caStatusPublished: "Published",
  caBtnReset: "Reset Form",
  caBtnSaveDraft: "Save Draft",
  caBtnPublish: "Publish",
  caMainContent: "Main Content",
  caArticleTitleLabel: "Article Title <span class=\"ca-hint\">*required</span>",
  caArticleTitlePlaceholder: "Enter an engaging article title...",
  caSlugLabel:
    "URL Slug <span class=\"ca-hint\">*auto-generated from title</span>",
  caSlugPlaceholder: "your-article-title",
  caExcerptLabel:
    "Summary / Excerpt <span class=\"ca-hint\">*for article cards on home & blog (max. 200 characters)</span>",
  caExcerptPlaceholder:
    "Write a short summary that grabs the reader's attention...",
  caArticleBody: "Article Content",
  caToolbarAriaLabel: "Text formatting",
  caToolbarBoldTitle: "Bold",
  caToolbarItalicTitle: "Italic",
  caToolbarUnderlineTitle: "Underline",
  caToolbarH2Title: "Heading 2",
  caToolbarH3Title: "Heading 3",
  caToolbarParagraphTitle: "Paragraph",
  caToolbarBulletTitle: "Bullet list",
  caToolbarBulletText: "• List",
  caToolbarNumberedTitle: "Numbered list",
  caToolbarNumberedText: "1. List",
  caToolbarQuoteTitle: "Quote",
  caToolbarQuoteText: "❝ Quote",
  caToolbarLinkTitle: "Insert link",
  caToolbarLinkText: "🔗 Link",
  caToolbarClearTitle: "Clear formatting",
  caToolbarClearText: "✕ Clear",
  caContentAriaLabel: "Article content",
  caEditorPlaceholder:
    "Start writing your article here... Use the toolbar above to format the text.",
  caMetadata: "Metadata",
  caBadgeLabel: "Badge Label <span class=\"ca-hint\">shown on card</span>",
  caContentType: "Content Type",
  caTypeArticle: "📄 Article",
  caTypeAudio: "🎧 Audio",
  caTypeVideo: "🎬 Video",
  caLevel: "Level",
  caLevelBeginner: "🟢 Beginner",
  caLevelIntermediate: "🟡 Intermediate",
  caLevelAdvanced: "🔴 Advanced",
  caReadTimeLabel: "Estimated Read Time <span class=\"ca-hint\">(minutes)</span>",
  caCategoryLabel:
    "Category / Tags <span class=\"ca-hint\">separate with commas</span>",
  caCategoryPlaceholder: "caregiver, training, career",
  caHeaderImage: "Header Image",
  caImageUrlLabel: "Image URL",
  caImagePreviewAlt: "Article image preview",
  caImageHelperText:
    "Leave blank to use the default image. Use an image URL from the <code>assets/images/</code> folder or an external URL.",
  caSeoOptional: "SEO (Optional)",
  caMetaDescLabel:
    "Meta Description <span class=\"ca-hint\">(max. 160 characters)</span>",
  caMetaDescPlaceholder: "Short description for search engines...",
  caListTitle: "Article List",
  caBtnNewArticle: "+ Create New Article",
  caEmptyList:
    "No articles yet. Click <strong>Create New Article</strong> to get started.",
  caToastViewArticle: "View Article →",
  caPromptInsertLink: "Enter the link URL:",
  caValidationTitleRequired: "Article title is required.",
  caValidationSlugRequired: "URL slug is required.",
  caValidationExcerptRequired: "Summary / excerpt is required.",
  caValidationContentRequired: "Article content cannot be empty.",
  caValidationSlugUsed: "Slug \"{slug}\" is already in use.",
  caToastDraftSaved: "Draft saved successfully!",
  caToastDraftFailed: "Failed to save draft. Please try again.",
  caConfirmPublish:
    "The article will be published and shown on the homepage and blog page. Continue?",
  caToastPublishSuccess: "Article published successfully!",
  caToastPublishFailed: "Failed to publish article. Please try again.",
  caConfirmReset: "Reset the form? Unsaved changes will be lost.",
  caLoadingArticles: "Loading articles...",
  caListPublishedDate: "Published: {date}",
  caListUpdatedDate: "Updated: {date}",
  caActionView: "View",
  caActionEdit: "Edit",
  caActionPublish: "Publish",
  caActionDelete: "Delete",
  caConfirmQuickPublish: "Publish article \"{title}\"?",
  caToastQuickPublishFailed: "Failed to publish.",
  caConfirmDelete:
    "Delete article \"{title}\"? This action cannot be undone.",
  caToastDeleteSuccess: "Article deleted successfully.",
  caToastDeleteFailed: "Failed to delete article.",
  avMetaReadTime: "⏱ {minutes} min read",
  avCtaTitle: "Ready to Start Your Journey?",
  avCtaBody:
    "Australian-certified caregiver program. Starting from Rp 500k/month.",
  avCtaButton: "Start Your Journey →",
  avBackToBlog: "← Back to Blog",
  avTagLabel: "Tags:",
  avNotFoundTitle: "Article Not Found",
  avNotFoundBack: "Back to Blog",
  avNoSlugFound: "No article slug was found.",
  avStoreUnavailable: "ArticlesStore is unavailable.",
  avArticleMissing:
    "The article with slug \"{slug}\" was not found or has not been published.",
  avDocumentTitleNotFound: "Article Not Found | Redline Academy",
  avDifficultyBeginner: "🟢 Beginner",
  avDifficultyIntermediate: "🟡 Intermediate",
  avDifficultyAdvanced: "🔴 Advanced",
...
function updatePageLanguage() {
  ...
  document.querySelectorAll("[data-i18n-data-placeholder]").forEach((element) => {
    const key = element.getAttribute("data-i18n-data-placeholder");
    element.setAttribute("data-placeholder", t(key));
  });
